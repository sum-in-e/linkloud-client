    ...
    <Modal onClose={onClose} size="xs" isCentered isOpen={true}>
      ...
      <ModalContent>
        <div className="flex flex-col items-center justify-center gap-5 px-5 py-10">
          ...
          <Link
            href="/kloud"
            className=" flex w-full select-none items-center justify-center gap-1 rounded-2xl bg-primary py-[0.6rem]  font-bold text-white hover:bg-primary-darker focus:outline-none"
          >
            시작하기
          </Link>
        </div>

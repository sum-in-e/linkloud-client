  ...
  return (
    <section className="flex w-full justify-center">
      <div className="flex max-w-screen-xl flex-col items-center px-4 py-14 md:px-10 md:py-20">
        <p className="md:reading-8 whitespace-pre-wrap text-center text-2xl font-semibold leading-9 text-zinc-800 md:whitespace-normal md:text-4xl">
          {`나중에 볼 링크를\n간편하게 저장하고 관리하세요.`}
        </p>
        <p className="my-5 whitespace-pre-wrap text-center text-xl font-semibold text-zinc-500 md:whitespace-normal md:text-xl">
          {`링크가 잊혀지거나\n방치되지 않도록 도와드립니다.`}
        </p>
        <Link
          href="/login"
